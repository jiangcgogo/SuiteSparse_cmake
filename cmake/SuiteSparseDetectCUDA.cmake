...
set(CMAKE_MODULE_PATH "${SuiteSparse_SOURCE_DIR}/cmake" ${CMAKE_MODULE_PATH})
...
if(CUDA_FOUND)
  ...
  elseif(CUDA_GENERATION STREQUAL "Auto")
    execute_process( COMMAND "${CUDA_NVCC_EXECUTABLE}" "${SuiteSparse_SOURCE_DIR}/cmake/checks/SuiteSparseDetectCudaArch.cu" "--run"
  ...
  set(SuiteSparse_CUDA_CC "${NVCC_FLAGS_EXTRA}")
  ...
  SS_OPTION(CUDA_FAST_MATH "Enable --use_fast_math for CUDA compiler " OFF)
